...
int main()
{
	...
	create_right(66, 30, 120);
    create_forward(150, 200);
	create_forward(390, 200);
    create_stop();
    create_block();
    ...
    create_block();
    create_stop();
    create_right(46, 30, 100);
    create_block();
    create_stop();
    set_servo_position(CLAW_PORT, CLAW_CLOSE);
    msleep(500);
    create_right(47, 30, 100);
    create_block();
    create_stop();
    set_servo_position(CLAW_PORT, CLAW_CLOSE);
    msleep(500);
